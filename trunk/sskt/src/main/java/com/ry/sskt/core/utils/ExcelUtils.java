...
public class ExcelUtils {
    ...
    public static Sheet CreateReader(MultipartFile file) {
...
//                FileInputStream is = new FileInputStream(new File(path));
    ...
    public static <T> void writeExcel(HttpServletRequest request, HttpServletResponse response, List<T> dataList, String fileName, Class<T> cls) {
...
//        buildExcelFile(".\\default.xlsx",wb);
    ...
    public static void responseError(HttpServletResponse response) {
        try {
            ...
            response.getWriter().write(mapper.writeValueAsString("download error"));
