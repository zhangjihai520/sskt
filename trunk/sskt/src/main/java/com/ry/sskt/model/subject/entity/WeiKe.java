...
public class WeiKe {
    ...
    public WeiKe(Subject subject) {
        int nomal = 999999999;
        this.weiKeName = subject.getSubjectName();
        this.teacherId = subject.getTeacherId();
        this.gradeId = subject.getGradeId();
        this.courseId = subject.getCourseId();
        this.overViewUrl = subject.getImagePath();
        this.filePath = subject.getFilePath();
        this.pptFilePath = subject.getPptFilePath();
        this.comment = subject.getComment();
        this.bookVersionId = nomal;
        this.courseMappingId = nomal;
        this.sectionId = nomal;
        this.statusFlag = 3;
    }
}
