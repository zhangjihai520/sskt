...
public class StudentAnswer implements IRedisStoredObject {

    private static String key = "StudentAnswer:ExamSetId_%s:UserId_%s";

    @Override
    public String getKey() {
        return String.format(key, this.examSetId,this.userId);
    }
    /// <summary>
    /// 作业id
    /// </summary>
