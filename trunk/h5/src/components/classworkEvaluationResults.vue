<template>
  <div class="childPage" :style="{ minHeight: windowHeight + 'px' }">
    ...
    <div class="chart">
      ...
      <div class="my-score">
        我的成绩:<span>{{
          evalautionResult && evalautionResult.CorrectCount
        }}</span
...
export default {
  name:'classworkEvaluationResults',
  directives: {
    TransferDom
  },
  components: {
