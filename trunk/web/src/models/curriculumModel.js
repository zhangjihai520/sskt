...
export default {
  ...
  effects: {
    ...
    *GetEvaluationResult({ payload }, { call }) {
    ...
    //随堂作业作答统计结果
    *GetAnswersStatistics({ payload }, { call }) {
      return yield call(services.GetAnswersStatistics, payload);
    },
    //资料列表
    ...
    *ChangeRoomStatus({ payload }, { call }) {
    ...
    // 超级助教根据房间号获取信息
    *GetMessageBySubjectRoomId({ payload }, { call }) {
      return yield call(services.GetMessageBySubjectRoomId, payload);
    },
    // 发送消息
    ...
    *SendFile({ payload }, { call }) {
    ...
    // 撤回消息
    *RemoveMessage({ payload }, { call }) {
      return yield call(services.RemoveMessage, payload);
    },
  },
  subscriptions: {
  }
