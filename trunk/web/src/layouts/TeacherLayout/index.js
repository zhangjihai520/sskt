...
class TeacherLayout extends Component {
  ...
  componentWillMount() {
    if (this.props.location.pathname == '/TeaOnline/Curriculum/ClassManagement') {
      this.setState({
          ...
          {this.state.showHead == true && (
            ...
            >
              ...
              <div className={style.footerWrap}>
                ...
                <div
                  className={this.props.Collapsed == true ? style.cloudPlatform : style.cloudPlatform2}
                  onClick={() => {
                ...
                {/* <div>
                <a  onClick={() => this.goClass()} >
                  <span style={{color:'#fff',display:'inline-block',paddingTop:'30px'}}>交流中心</span>
                </a>
              </div> */}
              </div>
            </Sider>
