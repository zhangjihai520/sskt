...
import EvaluationList from './evaluationList.js';
    ...
    this.setState(
      ...
      () => {
        dispatch({
          type:
            currentTag === 'default'
              ? 'curriculumModel/GetSubjectEvaluateList'
              : 'curriculumModel/GetTeacherToStudentEvaluateList',
          payload: {
            pageIndex,
            pageSize
          }
          ...
          this.setState({
            evaluationList: currentTag === 'default' ? res.SubjectList : res.EvaluateList,
    ...
    return (
      <div className={styles.root}>
        <ul className={styles.leftBox}>
          <li
            className={`${styles.menuItem} ${currentTag === 'default' ? styles.menuActive : ''}`}
            onClick={() => this.switchTag('default')}
          >
            我的评价
          </li>
          <li
            className={`${styles.menuItem}  ${currentTag === 'evaluateMe' ? styles.menuActive : ''}`}
            onClick={() => this.switchTag('evaluateMe')}
          >
            对我的评价
          </li>
        </ul>
