...
export default class ListenStream extends Component {
  ...
  render() {
    const { data, message, tarVideoStream, UserStatus, userInfoList, emojiData, panes, activeKey, unReadKey,topicListData = {}, answerList = [], serialNumber, ExamSetStatus} = this.state;
    ...
    return (
      <div className={style.contentArea}>
        ...
        <Row className={style.videoPanel}>
          ...
          <Col flex="150px" className={style.video_right}>
                  <Collapse defaultActiveKey={['1']} style={{ height: '699px', overflowY: 'auto' }}>
                    <Panel key="1" header={
