...
public class Message {
    ...
    public Message(String talkMessageId, int userType, String userTrueName, int talkTypeId, String content, String attachmentUrl, String fileSize, String thumbImageUrl, String userFace) {
