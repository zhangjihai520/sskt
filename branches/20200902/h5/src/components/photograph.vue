...
export default {
  ...
  methods: {
    ...
    postImg () {
      this.$emit('upload',this.base64ToFile(this.headerImage));
    ...
    base64ToFile(urlData) {
        ...
        let fileName = this.uuid()+"."+mime.split("/")[1];
...
.avatar {
  ...
  margin: 0 auto 80px;
    width: 64px;
    height: 64px;
    //background: url(../assets/ic_pic_upload.png) no-repeat center/contain;
    border-radius: 50%;
  .avatar-file {
    display: none;
  }
